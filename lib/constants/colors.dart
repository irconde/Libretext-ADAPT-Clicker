...
class CColors {
  static const Color primaryColor = Color(0xFF056ABD);
  static const Color lightPrimaryColor = Color(0xFFB6E1FF);
  static const Color clearAllColor = Color(0xFF90CCF2);
